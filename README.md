...
| `KM_DAKUTEN_HALO` / `KM_HANDAKUTEN_HALO` | `0.24` / `0.18` | Skip-ink gap carved around the enlarged mark, as a fraction of it; `KM_DAKUTEN_SKIP_INK=0` disables the carve |
