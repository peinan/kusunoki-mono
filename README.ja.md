...
Latin / ASCII / 記号 / リガチャに [Iosevka][iosevka]、日本語のかなと漢字に [LINE Seed JP][lineseed]、ターミナルのアイコンに [Nerd Fonts][nerd] を合成しています。
...
```sh
make setup   # 初回のみ。ツール導入、LINE Seed JP と Nerd Fonts のダウンロード
...
- [LINE Seed JP][lineseed]：日本語のかなと漢字（OFL 1.1）
